...
const Homelab: React.FC<HomelabProps> = ({ services }) => {
  return (
    <section id="homelab" className="py-20 px-6 max-w-7xl mx-auto">
      {/* Section title */}
      <h2 className="text-5xl font-black font-grotesk mb-12 rotate-1">HOMELAB SHOWCASE</h2>
      ...
      <div className="border-4 border-black bg-white p-8 shadow-[8px_8px_0px_0px_#000]">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service) => (
            <div key={service.id} className={`border-3 border-black ${service.bgColor} p-4`}>
              <div className="font-black text-lg mb-2">{service.name}</div>
